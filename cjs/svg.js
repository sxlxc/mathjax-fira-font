...
var FontData_js_1 = require("mathjax-full/cjs/output/svg/FontData.js");
...
var MathJaxFiraFont = (function (_super) {
    ...
    function MathJaxFiraFont(options) {
        ...
        try {
            for (var _b = __values(Object.keys(CLASS.variantCacheIds)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'FIRA-' + CLASS.variantCacheIds[variant];
            }
        }
    ...
    MathJaxFiraFont.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: Base.OPTIONS.dynamicPrefix + '/svg/dynamic' });
