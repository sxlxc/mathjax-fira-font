...
var FontData_js_1 = require("mathjax-full/cjs/output/chtml/FontData.js");
...
var MathJaxFiraFont = (function (_super) {
    ...
    MathJaxFiraFont.OPTIONS = __assign(__assign({}, Base.OPTIONS), { fontURL: Base.OPTIONS.dynamicPrefix = '/chtml/woff', dynamicPrefix: Base.OPTIONS.dynamicPrefix + '/chtml/dynamic' });
    ...
    MathJaxFiraFont.defaultStyles = __assign(__assign({}, FontData_js_1.ChtmlFontData.defaultStyles), { '.FIRA-N': {
